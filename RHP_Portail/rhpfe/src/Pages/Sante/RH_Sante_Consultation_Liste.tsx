        ...
        <>
          <Grid container spacing={5}>
            ...
            <Grid xs={8} sm={12} lg={3} xl={2}>
              <ComboBox
                rubrique="Typ_Acte_Infirmier" nomControle="Typ_Acte" label="Acte" valeur={criteres?.Typ_Acte || ""}
                onchange={stateChange} style={{ width: "100%" }}
              />
            </Grid>
          ...
          >
            <Bouton
              ...
              onClick={() => {
                myAxios("sante_consultation_liste", criteres)
                  .then((dt) => {
            ...
            <Bouton
              ...
              onClick={() => navigate(`../myspace/RH_Sante_Consultation/Consultation/new`)}
            />
          </div>
        </>
      </GroupBox>
      <Box sx={{ margin: "auto", padding: "2em 5px", width: "100%", overflow: "scroll" }}>
        <Grille
          ...
          onclick={({ colIndex, value }) => {
            if (colIndex === 0) navigate(`../myspace/RH_Sante_Consultation/Consultation/${value}`);
          }}
          sx={{
            "& .cl0": {
...
export default RH_Sante_Consultation_Liste;
type TCriteres = {
  Matricule?: string;
  Typ_Acte?: string;
  Dat_Du?: Date | null;
