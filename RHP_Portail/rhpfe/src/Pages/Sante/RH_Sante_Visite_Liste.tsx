...
/* Liste des visites medicales - vue PLANNING (sans contenu clinique).
        ...
        <>
          <Grid container spacing={5}>
            ...
            <Grid xs={8} sm={12} lg={3} xl={2}>
              <ComboBox
                rubrique="Typ_Visite"
                nomControle="Typ_Visite"
                label="Type de visite"
                valeur={criteres?.Typ_Visite || ""}
                onchange={stateChange}
                style={{ width: "100%" }}
              />
            </Grid>
            ...
            <Grid xs={12} sm={12} lg={6} xl={4}>
              ...
              >
                <CalendarZoom
                  ...
                  onchange={stateChange}
                  sx={{ flex: 1, minWidth: 0, "& input": { fontSize: { xs: "0.85em", sm: "1em" } } }}
          ...
          >
            <Bouton
              ...
              onClick={() => {
                myAxios("sante_visite_liste_planning", criteres)
                  .then((dt) => {
            ...
            <Bouton
              ...
              onClick={() => {
                navigate(`../myspace/RH_Sante_Visite/Visite médicale/new`);
              }}
            />
          </div>
        </>
      ...
      >
        <Grille
          ...
          onclick={({ colIndex, value }) => {
            if (colIndex === 0) {
              navigate(`../myspace/RH_Sante_Visite/Visite médicale/${value}`);
            }
          }}
          sx={{
            "& .cl0": {
...
export default RH_Sante_Visite_Liste;
type TCriteres = {
  Matricule?: string;
  Typ_Visite?: string;
  Statut?: string;
