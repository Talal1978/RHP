...
const RH_Declaration_AT_Liste = () => {
    const navigate = useNavigate();
    const { criteres, stateChange, ds, setDs, dsFields, setDsFields } =
        useEtatListe<TCriteres>("RH_Declaration_AT_Liste", initialiserCriteres);
                ...
                <>
                    ...
                    >
                        <Bouton
                            ...
                            onClick={() => {
                                myAxios("declarationATListe", criteres)
                                    .then((dt) => {
            ...
            >
                <Grille
                    ...
                    onclick={({ colIndex, value }) => {
                        if (colIndex === 0) {
                            navigate(`../myspace/RH_Declaration_AT/Déclaration Accident/${value}`);
                        }
                    }}
                    sx={{
                        "& .cl0": {
...
export default RH_Declaration_AT_Liste;
