...
const Demande_Doc_Administratif_Liste = () => {
    const navigate = useNavigate();
    const { criteres, stateChange, ds, setDs, dsFields, setDsFields } =
        useEtatListe<TCriteres>("Demande_Doc_Administratif_Liste", initialiserCriteres);
    ...
    return (
        <>
            <GroupBox
                label="Critères Demande Documents"
                showBorders={!isSmall}
                showTitre={true}
                sx={{
                    "& .grpDiv": {
                ...
                <>
                    ...
                    >
                        <Bouton
                            ...
                            onClick={() => {
                                myAxios("demande_doc_admin_liste", criteres)
                                    .then((dt) => {
            ...
            >
                <Grille
                    ...
                    onclick={({ colIndex, value }) => {
                        if (colIndex === 0) {
                            navigate(`../myspace/Demande_Doc_Administratif/Demande Documents/${value}`);
                        }
                    }}
                    sx={{
                        "& .cl0": {
...
export default Demande_Doc_Administratif_Liste;
