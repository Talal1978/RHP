...
const Outillage_Mouvement_Liste = () => {
    const navigate = useNavigate();
    const { criteres, stateChange, ds, setDs, dsFields, setDsFields } =
        useEtatListe<TCriteres>("Outillage_Mouvement_Liste", initialiserCriteres);
    ...
    return (
        <>
            <GroupBox
                label="Critères Mouvements Outillage"
                showBorders={!isSmall}
                showTitre={true}
                sx={{
                    "& .grpDiv": {
                ...
                <>
                    ...
                    >
                        <Bouton
                            ...
                            onClick={() => {
                                myAxios("outillage_mouvement_liste", criteres)
                                    .then((dt) => {
            ...
            >
                <Grille
                    ...
                    onclick={({ colIndex, value }) => {
                        if (colIndex === 0) {
                            navigate(`../myspace/Outillage_Mouvement/Mouvement Outillage/${value}`);
                        }
                    }}
                    sx={{
                        "& .cl0": {
...
export default Outillage_Mouvement_Liste;
