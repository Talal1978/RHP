...
const RH_Discipline_Liste = () => {
    const navigate = useNavigate();
    const { criteres, stateChange, ds, setDs, dsFields, setDsFields } =
        useEtatListe<TCriteres>("RH_Discipline_Liste", initialiserCriteres);
                ...
                <>
                    ...
                    >
                        <Bouton
                            ...
                            onClick={() => {
                                myAxios("discipline_liste", criteres)
                                    .then((dt) => {
            ...
            >
                <Grille
                    ...
                    onclick={({ colIndex, value }) => {
                        if (colIndex === 0) {
                            navigate(`../myspace/RH_Discipline/Discipline/${value}`);
                        }
                    }}
                    sx={{
...
export default RH_Discipline_Liste;
type TCriteres = {
    Matricule?: string;
    Typ_Sanction?: string;
    Dat_Du?: Date | null;
