...
const Recrutement_Demande_Liste = () => {
    const navigate = useNavigate();
    const { criteres, stateChange, ds, setDs, dsFields, setDsFields } =
        useEtatListe<TCriteres>("Recrutement_Demande_Liste", initialiserCriteres);
                ...
                <>
                    ...
                    >
                        <Bouton
                            ...
                            onClick={() => {
                                myAxios("get_recrutement_demande_liste", criteres)
                                    .then((dt) => {
                        ...
                        <Bouton
                            ...
                            onClick={() => {
                                navigate(`/myspace/Recrutement_Demande/Recrutement/new`);
                            }}
                        />
                    </div>
                </>
            ...
            >
                <Grille
                    ...
                    onclick={({ colIndex, value }) => {
                        if (colIndex === 0) {
                            navigate(`/myspace/Recrutement_Demande/Recrutement/${value}`);
                        }
                    }}
                    sx={{
                        "& .cl0": {
...
export default Recrutement_Demande_Liste;
