...
useEffect(() => {
  ...
  const InputComponent = useMemo(() => {
    const commonSx = {
        "& .MuiInputBase-input": { backgroundColor: 'white !important', padding: '5px 10px' },
        "& .MuiSelect-select": { backgroundColor: 'white !important' }
    };
    const numericSx = {
        ...commonSx,
        "& .MuiInputBase-input": { 
      ...
      case "liste":
        ...
        return (
          <Select
            ...
            variant="standard"
            displayEmpty
            sx={{ ...commonSx, width: "100%", borderBottom: `1px solid gray`, backgroundColor: 'white !important' }}
          >
