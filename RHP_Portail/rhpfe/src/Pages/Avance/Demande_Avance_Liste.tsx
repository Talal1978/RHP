...
const Demande_Avance_Liste = () => {
  const navigate = useNavigate();
  const { criteres, stateChange, ds, setDs, dsFields, setDsFields } =
    useEtatListe<TCriteres>("Demande_Avance_Liste", initialiserCriteres);
        ...
        <>
          ...
          >
            <Bouton
              ...
              onClick={() => {
                myAxios("demande_avance_liste", criteres)
                  .then((dt) => {
...
export default Demande_Avance_Liste;
type TCriteres = {
  Matricule?: string;
  Cod_Entite?: string;
  Statut?: string;
