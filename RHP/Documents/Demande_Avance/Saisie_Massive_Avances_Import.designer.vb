...
Partial Class Saisie_Massive_Avances_Import
    inherits Ecran
    ...
    Private Shared Sub ENCAddToList(ByVal value As Object)
        Dim list As List(Of WeakReference) = Saisie_Massive_Avances_Import.ENCList
        SyncLock list
            If (Saisie_Massive_Avances_Import.ENCList.Count = Saisie_Massive_Avances_Import.ENCList.Capacity) Then
                Dim index As Integer = 0
                Dim num3 As Integer = (Saisie_Massive_Avances_Import.ENCList.Count - 1)
                Dim i As Integer = 0
                Do While (i <= num3)
                    Dim reference As WeakReference = Saisie_Massive_Avances_Import.ENCList.Item(i)
                    If reference.IsAlive Then
                        If (i <> index) Then
                            Saisie_Massive_Avances_Import.ENCList.Item(index) = Saisie_Massive_Avances_Import.ENCList.Item(i)
                        End If
                        index += 1
                    End If
                    i += 1
                Loop
                Saisie_Massive_Avances_Import.ENCList.RemoveRange(index, (Saisie_Massive_Avances_Import.ENCList.Count - index))
                Saisie_Massive_Avances_Import.ENCList.Capacity = Saisie_Massive_Avances_Import.ENCList.Count
            End If
            Saisie_Massive_Avances_Import.ENCList.Add(New WeakReference(RuntimeHelpers.GetObjectValue(value)))
        End SyncLock
    End Sub
    ...
    Private Sub InitializeComponent()
        ...
        Me.ExcelSheets_cbo.Location = New System.Drawing.Point(284, 4)
        Me.ExcelSheets_cbo.Margin = New System.Windows.Forms.Padding(4)
        ...
        Me.Name = "Saisie_Massive_Avances_Import"
        Me.Padding = New System.Windows.Forms.Padding(2)
        Me.ShowIcon = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Tag = "ECR"
        Me.Text = "Import des avances"
