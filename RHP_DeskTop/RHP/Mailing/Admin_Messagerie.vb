...
Public Class Admin_Messagerie
    ...
    Private Sub ButtonItem1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Save_pb.Click
        ...
        If Not EnvoiDeMail(Mail_Addr_Text.Text, Mail_Addr_Text.Text, "Test Envoi de Mail", Test_Mail_Text.Text).envoye Then
            MessageBoxRHP(347)
    ...
    Sub EnvoiTest()
        ...
        oSmtpServer.Host = Smtp_Mail_Text.Text
        oSmtpServer.EnableSsl = Ssl_Actif.Checked
        If EnvoiDeMail(Mail_Addr_Text.Text, Mail_Addr_Text.Text, "Test Envoi de Mail", Test_Mail_Text.Text).envoye Then
            MessageBoxRHP(348)
        Else
            MessageBoxRHP(349)
        End If
