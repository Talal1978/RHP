Public Class RH_Dossier_Maladie_Liste
    ...
    Private Sub Ges_Pie_Clt_GRD_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Ges_Pie_Clt_GRD.CellContentDoubleClick
        ...
        ElseIf e.ColumnIndex = Ges_Pie_Clt_GRD.Columns("N° demande").Index Then
            Dim f As New RH_Dossier_Maladie
            With f
                .remboursement_Grp.Visible = True
                .Matricule_txt.Text = Ges_Pie_Clt_GRD.Item("Matricule", e.RowIndex).Value
                .Num_Dossier_txt.Text = Ges_Pie_Clt_GRD.Item("N° demande", e.RowIndex).Value
                newShowEcran(f, True)
            End With
        End If
    End Sub
    ...
    Sub Requesting()
        ...
        End If
        Cod_Sql = " SELECT  Num_Dossier as 'N° demande', Matricule,Nom,Nom_Malade as 'Patient',dbo.FindRubrique('Statut_Signature',Statut) as Statut, Dat_Dossier as 'Date', Mnt_Engage as 'Montant engagé',Envoye_Le as 'Date envoi',
...
where " & swhere & " Order by [Date] desc"
        ...
        With Ges_Pie_Clt_GRD
            ...
            .Columns("Remboursement").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
            .Columns("Remboursement").DefaultCellStyle.Format = "N2"
            If Matricule_txt.Text <> "" Then
    ...
    Private Sub Ges_Pie_Clt_GRD_CellMouseMove(sender As Object, e As DataGridViewCellMouseEventArgs) Handles Ges_Pie_Clt_GRD.CellMouseMove
        With Ges_Pie_Clt_GRD
            If e.RowIndex < 0 Or e.ColumnIndex < 0 Then
                .Cursor = Cursors.Default
            ElseIf e.ColumnIndex = .Columns("Matricule").Index Or e.ColumnIndex = .Columns("N° demande").Index Then
                .Cursor = Cursors.Hand
            Else
                .Cursor = Cursors.Default
            End If
